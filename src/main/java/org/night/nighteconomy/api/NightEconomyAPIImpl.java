...
public class NightEconomyAPIImpl implements NightEconomyAPI {
    ...
    public TycoonInfo getCurrentTycoon(String currencyId) {
        return economyService.getCurrentTycoonInfo(currencyId);
    }

    @Override
    public TycoonInfo getLastKnownTycoon(String currencyId) {
        return economyService.getLastKnownTycoonInfo(currencyId);
    }

    @Override
    public String getTycoonTag(String currencyId) {
        return economyService.getTycoonTag(currencyId);
    }
